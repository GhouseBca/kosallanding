...
export default function WhyChooseKosal() {
    return (
        <section className="w-full h-fit bg-white dark:bg-black 
                    py-8 px-6 
            ...
            <div className="w-full h-fit gap-6 md:gap-10 flex flex-col">
                ...
                <h2 className="text-left text-3xl md:text-4xl lg:text-5xl font-bold font-manrope leading-tight text-black dark:text-white">
            ...
            <div className="block xl:hidden">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div className="relative w-full h-fit max-w-[534px] rounded-[32px] bg-[#F8F8F8] dark:bg-[#161616] 
                        flex flex-row md:flex-col justify-between gap-4 lg:gap-4 px-6 py-6 sm:h-full sm:px-8">
                        <img
                            src="/img/vetted.png"
                            alt="Vetted Engineers"
                            className="w-[106px] h-[82px] opacity-100 sm:absolute md:top-6 md:right-6 md:w-[197px] md:h-[153px] xl:static"
                        />
                        <div className="text-black dark:text-white w-full h-fit flex flex-col gap-2 mt-auto opacity-100">
                            <h3 className="text-[#110C22] dark:text-white font-inter font-semibold text-[20px] leading-[32px] tracking-[-0.01em] md:text-[26px] md:leading-[40px]">
                                Vetted Engineers
                            </h3>
                    ...
                    <div className="relative rounded-[32px] bg-gray-50 dark:bg-[#161616] flex flex-row-reverse justify-between
                        h-[160px] p-6 md:flex-col md:h-[310.5px] md:px-8 md:py-6">
                        <img
                            src="/img/rocket.png"
                            alt="Fast Onboarding"
                            className="object-contain w-auto h-[82px] sm:absolute md:top-6 md:right-6 md:h-[157px] xl:static"
                        />
                        <div className="flex flex-col text-black dark:text-white w-full h-fit gap-2 md:h-[104px] max-w-full justify-center md:mt-auto">
                            <h3 className="font-semibold text-[20px] text-[#110C22] dark:text-white leading-[32px] tracking-[-0.01em] md:text-[26px] md:leading-[40px]">
                                Fast Onboarding
                            </h3>
                    ...
                    <div className="relative rounded-[32px] bg-gray-50 dark:bg-[#161616]
                        flex flex-row justify-between gap-4 p-6 md:flex-col md:px-8 md:py-6 h-[136px] md:h-[310.5px]">
                        <img
                            src="/img/chat.png"
                            alt="Flexible Engagement"
                            className="object-contain w-[106px] h-[82px] md:absolute md:top-6 md:right-6 md:w-[185px] md:h-[148px] xl:static"
                        />
                        <div className="flex flex-col z-10 mt-auto max-w-[293px] text-black dark:text-white justify-center sm:mt-auto">
                            <h3 className="text-[#110C22] dark:text-white font-inter font-semibold
                    ...
                    <div className="relative rounded-[32px] bg-gray-50 dark:bg-[#161616] flex flex-row-reverse justify-between gap-4 p-6
                        md:flex-col md:px-8 md:py-6 h-[136px] md:h-[310.5px]">
                        <img
                            src="/img/thumb.png"
            ...
            <div className="hidden xl:flex flex-row gap-8 h-fit">
                ...
                <div className="w-full h-fit max-w-[534px] rounded-[32px] bg-[#F8F8F8] dark:bg-[#161616] 
                        flex flex-col justify-between gap-4 px-6 py-6 ">
                    <img
                        src="/img/vetted.png"
                        alt="Vetted Engineers"
                        className=" opacity-100 w-[470px] h-[485px]"
                    />
                    <div className="text-black dark:text-white w-full h-fit flex flex-col gap-2 mt-auto opacity-100">
                        <h3 className=" text-[#110C22] dark:text-white font-inter font-semibold tracking-[-0.01em] text-[26px] leading-[40px] h-[40px] opacity-100">
                            Vetted Engineers
                        </h3>
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-6 sm:gap-8 w-full">
                    ...
                    <div className="relative col-start-1 col-span-2 row-start-1 row-span-1
                            ...
                            h-[310.5px] px-8 py-6 opacity-100"
                        >
                    ...
                    <div className="relative rounded-[32px] bg-gray-50 dark:bg-[#161616] flex flex-col justify-between gap-4 p-6 col-start-1 row-start-2
                            max-w-[534px] h-[310.5px] opacity-100">
                        <img src="/img/chat.png" alt="Flexible Engagement" className="absolute right-0 top-0 object-contain w-[152px] h-[152px] opacity-100" />
                    ...
                    <div className="relative rounded-[32px] bg-gray-50 dark:bg-[#161616] flex flex-col justify-between gap-4 p-6 col-start-2 row-start-2
                            max-w-[534px] h-[310.5px] opacity-100">
                        <img src="/img/thumb.png" alt="Quality Guaranteed" className="absolute right-0 sm:top-0 md:top-0 lg:top-0 object-contain w-[106px] h-[82px] sm:w-[185px] sm:h-[148px] lg:w-[152px] lg:h-[152px] opacity-100" />
                        <div className="flex flex-col z-10 mt-auto max-w-[293px] text-black dark:text-white">
                            <h3 className=" text-[#110C22] dark:text-white font-inter font-semibold tracking-[-0.01em] text-[26px] leading-[40px] h-[40px] opacity-100">
                                Quality Guaranteed
                            </h3>
