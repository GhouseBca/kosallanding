  ...
  return (
    <section className="relative flex flex-col bg-white dark:bg-black px-6 py-8 gap-10 opacity-100 md:px-10 md:py-12 lg:px-14 lg:py-16 xl:px-16 xl:py-20">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-10 opacity-100">
        {/* Left - Text */}
        <h2 className="h-[128px] opacity-100 md:h-[176px] lg:h-[288px] lg:max-w-[396px] lg:w-1/2 xl:h-[360px] xl:max-w-[572px] text-[#110C22] dark:text-white font-manrope font-semibold text-[52px] leading-[64px] tracking-[-0.01em] md:text-[76px] md:leading-[88px] md:tracking-normal md:font-bold lg:text-[88px] lg:leading-[96px] lg:font-bold xl:text-[104px] xl:leading-[120px] xl:font-bold">
          <span className="block lg:hidden gap-2">
            Let’s <span className="text-[#0084FF] dark:text-[#71BBFF]">Get in</span> <br />
