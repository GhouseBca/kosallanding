        ...
        <section className="px-[24px] py-[32px] 
            ...
            <div className="flex flex-col gap-5 opacity-100">
                ...
                <div className="w-full h-fit flex flex-col lg:flex-row gap-[24px] opacity-100">
                    ...
                    <h1 className="font-inter font-semibold text-[32px] text-[#110C22] dark:text-white leading-[40px] tracking-[-0.01em]
                            md:font-manrope md:font-bold md:text-[44px] md:leading-[64px]
                            lg:text-[52px] lg:leading-[64px] 
                            xl:font-inter xl:text-[64px] xl:leading-[72px] opacity-100 gap-[56px]">
                    ...
                    <p className="text-[#4F4B5C] dark:text-[#C2C2C2] font-manrope font-medium 
