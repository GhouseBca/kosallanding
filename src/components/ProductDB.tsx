...
export default function CustomLayoutPage() {
  return (
    <section className="flex flex-col w-full h-fit gap-4 opacity-100 p-2 bg-white dark:bg-black
        xl:flex-row md:gap-6 md:p-3 lg:p-4 xl:w-[1440px] xl:gap-8 xl:p-4">
