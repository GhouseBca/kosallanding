...
const StatsGridItem: React.FC<StatsGridItemProps> = ({ value, label }) => {
  return (
    <div className="bg-[#F8F8F8] dark:bg-[#161616] opacity-100 
      ...
      <span className="font-inter font-semibold text-[32px] leading-[40px] tracking-[-0.01em] 
              text-[#110C22] dark:text-white xl:font-manrope xl:text-[44px] xl:leading-[64px]">
        {value}
      </span>
      <span className=" font-manrope font-medium text-[14px] text-nowrap leading-[24px] tracking-normal 
